System.register(["@beyond-js/kernel@0.1.2/bundle","@beyond-js/kernel@0.1.2/core","@beyond-js/widgets@0.1.1/render","@beyond-js/kernel@0.1.2/styles"], (_exports, _context) => {

const bimport = specifier => {
	const dependencies = new Map([["@beyond-js/kernel","0.1.2"],["@beyond-js/widgets","0.1.1"]]);
...
return {
setters: [dep => dependencies.set('@beyond-js/kernel@0.1.2/bundle', dep), dep => dependencies.set('@beyond-js/kernel@0.1.2/core', dep), dep => dependencies.set('@beyond-js/widgets@0.1.1/render', dep), dep => dependencies.set('@beyond-js/kernel@0.1.2/styles', dep)],
execute: function() {
...
// .beyond/uimport/temp/@beyond-js/widgets/controller.0.1.1.js
var controller_0_1_1_exports = {};
__export(controller_0_1_1_exports, {
...
var dependency_1 = __toESM(require("@beyond-js/kernel@0.1.2/core"), 0);
var dependency_2 = __toESM(require("@beyond-js/widgets@0.1.1/render"), 0);
var dependency_3 = __toESM(require("@beyond-js/kernel@0.1.2/styles"), 0);
var import_meta = {};
var {
  Bundle: __Bundle
} = dependency_0;
...
module.exports = __toCommonJS(controller_0_1_1_exports);
};
