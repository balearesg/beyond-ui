System.register(["@beyond-js/kernel@0.1.2/bundle","@beyond-js/kernel@0.1.2/core","@beyond-js/widgets@0.1.1/render","@beyond-js/kernel@0.1.2/routing"], (_exports, _context) => {
...
return {
setters: [dep => dependencies.set('@beyond-js/kernel@0.1.2/bundle', dep), dep => dependencies.set('@beyond-js/kernel@0.1.2/core', dep), dep => dependencies.set('@beyond-js/widgets@0.1.1/render', dep), dep => dependencies.set('@beyond-js/kernel@0.1.2/routing', dep)],
execute: function() {
...
// .beyond/uimport/temp/@beyond-js/widgets/routing.0.1.1.js
...
var dependency_3 = __toESM(require("@beyond-js/kernel@0.1.2/routing"), 0);
var import_meta = {};
var {
  Bundle: __Bundle
} = dependency_0;
